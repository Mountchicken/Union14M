...
test_root = '../benchmarks_lmdb'
test_img_prefix1 = f'{test_root}/CUTE80/'
test_img_prefix2 = f'{test_root}/IC13_1015/'
test_img_prefix3 = f'{test_root}/IC15_2077/'
test_img_prefix4 = f'{test_root}/SVT/'
test_img_prefix5 = f'{test_root}/SVTP/'
test_img_prefix6 = f'{test_root}/IIIT5k_3000/'

test_ann_file1 = f'{test_root}/CUTE80/'
test_ann_file2 = f'{test_root}/IC13_1015/'
test_ann_file3 = f'{test_root}/IC15_2077/'
test_ann_file4 = f'{test_root}/SVT/'
test_ann_file5 = f'{test_root}/SVTP/'
test_ann_file6 = f'{test_root}/IIIT5k_3000/'
