...
test_img_prefix4 = f'{test_root}/meanless'
test_img_prefix5 = f'{test_root}/multi'
test_img_prefix6 = f'{test_root}/multi_oriented'
test_img_prefix7 = f'{test_root}/honest'
test_img_prefix8 = f'{test_root}/honest_ori'
...
# test_ann_file7 = f'{test_root}/honest/annotation.jsonl'
# test_ann_file8 = f'{test_root}/honest_ori/annotation.jsonl'
...
test_root9 = '../Union4M/Union4M/test_sets_GN'

test_img_prefix9 = f'{test_root9}/'
test_ann_file9 = f'{test_root9}/annotation.jsonl'

test9 = dict(
    type='OCRDataset',
    img_prefix=test_img_prefix9,
    ann_file=test_ann_file9,
    loader=dict(
        type='AnnFileLoader',
        repeat=1,
        file_format='txt',
...
test_list = [test1, test2, test3, test4, test5, test6, test9]
